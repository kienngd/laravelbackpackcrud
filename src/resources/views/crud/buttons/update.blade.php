@if ($crud->hasAccess('update'))
	...
	<!-- Single edit button -->
	<a href="{{ url($crud->route.'/'.$entry->getKey().'/edit') }}" class="dropdown-item btn btn-hover-bg-success btn-sm btn-link"><i class="la la-edit mt-1"></i> {{ trans('backpack::crud.edit') }}</a>
