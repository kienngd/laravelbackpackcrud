                     ...
                     details: {
                         ...
                         renderer: function(api, rowIdx, columns) {
                             ...
                             var data = $.map(columns, function(col, i) {
                                 ...
                                 //anhnq: Remove cell format (text alignment) if deemed uncessary
                                 //Check if the format needed to be cleared
                                if ("{{ $crud->sameFormatAsColumns ?? 'true' }}" == 'false') {
                                     //REGEX to remove keywords from col.data
                                     let removeArray = ['float-left', 'float-right', 'text-left',
                                         'text-right', 'text-center'
                                     ];
                                     let regex = new RegExp(removeArray.join("|"), "g");
                                     col.data = col.data.replace(regex, "");
                                 }
 ...
 <script type="text/javascript">
     jQuery(document).ready(function($) {
         ...
         @if ($crud->getOperationSetting('resetButton') ?? true)
             ...
             /*
              *   anhnq: add reset button after the datatable_info_stack or not (showing X records in total Y records ...)
              */
         ...
         //anhnq: move "showing x out of y" info to the bottom
         $('#datatable_info_stack').insertAfter($('#crudTable_wrapper'));
